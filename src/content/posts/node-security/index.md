...
pubDate: 2025-09-19
color: '#e80ccf'
description: 'Our industry runs on packages published by strangers at 2 a.m. Here is why that is terrifying, and how to protect yourself.'
...
-   **What to do:**
    -   **Default to no install scripts, then allow only what’s required:**
        ...
        -   For npm/yarn whitelisting at scale, use a maintained helper like LavaMoat’s [`allow-scripts`](https://www.npmjs.com/package/@lavamoat/allow-scripts) (`npx @lavamoat/allow-scripts`) to manage an explicit allow-list.
...
-   **What to do:**
    ...
    -   Consider Node’s [permission model](https://nodejs.org/api/permissions.html): run with flags that restrict `fs`/`net`/`process` access to what the app needs.
