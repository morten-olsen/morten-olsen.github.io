...
And one more thing that's quietly become one of my most valuable habits: **hand-crafting reference material.** I spend time building small, well-defined, thoroughly documented units — patterns, scaffolds, architectural building blocks — that represent how I *want* things to work. Not full implementations, but clear expressions of intent. Then, instead of hoping the agent invents the right approach, I hand it the reference and let it adapt the pattern to the specific project.

Before AI, I had similar templates, but I always had to manually adapt them to each codebase. Now I invest the time once to make the reference material really strong — clear structure, good documentation, explicit rationale — and the agent handles the adaptation. The irony is that AI has made me *more* deliberate about craftsmanship, not less. I just apply that craftsmanship to the patterns and reference material rather than to every line of output.
...
And if the economic argument doesn't convince you, here's the technical one — because we've already lived through this exact story, multiple times.

We used to write in assembly. A simple application was a feat of precision craftsmanship that took weeks. Then we got high-level languages and it took days. Then libraries and it took hours. Today, the app that once required a team of assembly wizards can be scaffolded before your coffee gets cold — and that's *without* AI.

So did we conclude software was "solved"? Did the industry shrink?

Of course not. Every time we made building easier, the definition of "good enough" expanded to fill the space. Customers didn't say "great, ship less." They said "great, now I want it to do *this* too." More features, more polish, more integrations, faster delivery. The bar just kept rising. And the developers who thrived weren't the ones mourning the death of hand-tuned assembly — they were the ones who grabbed the new tools and started thinking bigger.

We didn't need fewer developers when we got React. We needed developers with bigger ambitions. AI is the next rung on that same ladder.

### The AI Version

I think the same cycle — both the economic outsourcing version and the technical tooling version — is playing out again, but faster.
...
Let me give you a concrete example, because I think this is easier to *show* than to argue.
...
You don't need a list of "AI-proof skills." Any such list would have a shelf life measured in months. Instead, by working with AI daily, you *feel* the frontier. You know it in your bones: "this part, I needed to handle. That part, it did fine." Over time, that builds into a clear, confident picture of your own value.
